...
const Splatoon3Upcoming = new Client("de-DE", new Options({ festURL: "https://splatoon3ink-archive.nyc3.digitaloceanspaces.com/2024/05/16/2024-05-16.01-00-00.festivals.json" }));
